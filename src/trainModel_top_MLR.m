function [] = ...
            trainModel_top_MLR(CNN_Cal1, CNN_Cal2)
            
[Model_MLR, ~] = trainModel_MLR(CNN_Cal1, CNN_Cal2);

yfit = Model_MLR.predictFcn(CNN_Cal1);
...
save A_MLR_result.mat yfit  sub  range_max  range_min  rmse  R2  PI_99_low  PI_99_high  PI_95_low  PI_95_high Model_MLR  CNN_Cal2

end



function [trainedModel, validationRMSE] = trainModel_MLR(trainingData, responseData)
...
% 由 MATLAB 于 2022-02-27 03:31:42 自动生成
...
%
% 将输入转换为表
inputTable = array2table(trainingData, 'VariableNames', {'CNN_Cal1'});

predictorNames = {'CNN_Cal1'};
...
concatenatedPredictorsAndResponse.CNN_Cal10 = response;
linearModel = fitlm(...
...
for fold = 1:KFolds
    ...
    concatenatedPredictorsAndResponse.CNN_Cal10 = trainingResponse;
    linearModel = fitlm(...
        concatenatedPredictorsAndResponse, ...
        'linear', ...
        'RobustOpts', 'off');
