function [] = ...
            trainModel_top_GPR(CNN_Cal1, CNN_Cal2)
            
[Model_GPR, ~] = trainModel_GPR(CNN_Cal1, CNN_Cal2);

yfit = Model_GPR.predictFcn(CNN_Cal1);
...
save A_GPR_result.mat yfit  sub  range_max  range_min  rmse  R2  PI_99_low  PI_99_high  PI_95_low  PI_95_high Model_GPR  CNN_Cal2
