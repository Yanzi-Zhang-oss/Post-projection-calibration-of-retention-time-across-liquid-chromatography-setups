...
%    工作表: 内部训练和测试集
%
% 由 MATLAB 于 2021-11-06 14:23:38 自动生成

%% 设置导入选项并导入数据

function [RTVanquishQEPLus1] = excel_import_other_data()
opts = spreadsheetImportOptions("NumVariables", 14);

% 指定工作表和范围
opts.Sheet = "内部训练和测试集";
opts.DataRange = "M264:Z323";
...
% 指定变量属性
opts = setvaropts(opts, ["RSLC1", "GOLD2", "T31", "GOLD4", "RSLC4", "RSLC5", "RSLC3", "RSLC7", "RSLC8", "GOLD1", "GOLD3", "RSLC2", "GOLD5", "RSLC6"], "FillValue", 0);
